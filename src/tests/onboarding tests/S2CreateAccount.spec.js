...
let S2Component = <BrowserRouter><S2CreateAccount user={{first_name: "Vanessa", last_name: "Staneck", job_title: "manager", org_name: "kansha", org_name: "less than 20", industry: "accounting"  }} /></BrowserRouter>;
...
describe('S2', () => {
  ...
  it('renders without crashing', () => {
    ...
    const { getByText, history } = renderWithRouter(<S2CreateAccount user={{first_name: "Vanessa", last_name: "Staneck", job_title: "manager", org_name: "kansha", org_name: "less than 20", industry: "accounting"  }} />);
