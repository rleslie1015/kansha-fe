      ...
      <div style={styles.headerContainer}>
        <Typography component='div' className={classes.heading}  >
          <div style={styles.info}>
            ...
            <Button variant='contained' className={classes.signButton} onClick={auth.login} fontFamily='montserrat'>Get Started</Button>
            <Button onClick={()=>window.location.hash='features'} variant='contained' className={classes.learnButton} fontFamily='montserrat'>Learn More</Button>
          </div>
