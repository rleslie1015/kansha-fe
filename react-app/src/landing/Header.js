      ...
      <div style={styles.headerContainer}>
        <Typography component='div' className={classes.heading}  >
          <div style={styles.info}>
            ...
            <RecogModal setOpen={setOpen} open={open} first_name='Andrew' last_name='Goenner' job_title='Slapper of Fish' department='Fishslappery' profile_pic='https://www.sackettwaconia.com/wp-content/uploads/default-profile.png
' />
          </div>
